...
extern volatile uint32_t g_usb_msc_init_count;
extern volatile uint32_t g_usb_msc_capacity_count;
extern volatile uint32_t g_usb_msc_read_count;
extern volatile uint32_t g_usb_msc_fail_count;
